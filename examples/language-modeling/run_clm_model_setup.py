...
def main():
    ...
    print('completed reading gaudi config!')
    ...
    print('completed getting model config!')
    ...
    #     )
    print('completed getting tokenizer!')
    ...
    print('completed instantiating model!')
